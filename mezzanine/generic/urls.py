...
urlpatterns = patterns("mezzanine.generic.views",
    ...
    url(r'^view/(?P<username>.*)$', "commentProfile", name="commentProfile"),
   	url(r'^comments/object/liked/(?P<obj>.*)/$', "comment_thread_most_liked_view", name="comment_thread_most_liked_view"),
   	url(r'^comments/object/recent/(?P<obj>.*)/$', "comment_thread_most_recent_view", name="comment_thread_most_recent_view"),
   	url(r'^comments/object/default/(?P<obj>.*)$', "comment_thread_default_view", name="comment_thread_default_view"),
   	url(r'^comments/object/social/(?P<obj>.*)/$', "comment_thread_social_view", name="comment_thread_social_view"),
    url(r'^comments/object/social-deep/(?P<obj>.*)/$', "comment_thread_social_view_level2", name="comment_thread_social_view_level2"),
